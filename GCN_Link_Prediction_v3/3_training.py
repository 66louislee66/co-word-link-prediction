...
# embed_df = pd.DataFrame(embed_matrix)
# embed_df.to_csv(r'/home/lym/lab/project_work/project_versions/GCN_Link_Prediction_v3/data/3_word_embeddings_inference.csv', index=False)

# # ! Testing model

# comatix_test_label = pd.read_csv(r'/home/lym/lab/project_work/project_versions/GCN_Link_Prediction_v3/data/2_comatrix_test_label.csv', index_col=0)
...
# balanced_data.to_csv(r'/home/lym/lab/project_work/project_versions/GCN_Link_Prediction_v3/data/3_source_data_label.csv', index=False)
...
# balanced_data.to_csv(r'/home/lym/lab/project_work/project_versions/GCN_Link_Prediction_v3/data/3_modified_data_label.csv', index=False)
...
upper_tri = pd.read_csv(r'/home/lym/lab/project_work/project_versions/GCN_Link_Prediction_v3/data/3_modified_data_label.csv')
